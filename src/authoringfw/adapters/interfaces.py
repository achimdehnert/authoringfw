...
class IWorldAdapter(Protocol):
    ...
    async def update_world(self, world_id: str, **fields: object) -> WorldContext: ...
...
class ILocationAdapter(Protocol):
    ...
    async def update_location(self, location_id: str, **fields: object) -> Location: ...
...
class ICharacterAdapter(Protocol):
    ...
    async def update_character(self, character_id: str, **fields: object) -> CharacterProfile: ...
...
class IStoryAdapter(Protocol):
    ...
    async def update_story(self, story_id: str, **fields: object) -> StoryProfile: ...
...
class ISceneAdapter(Protocol):
    ...
    async def update_scene(self, scene_id: str, **fields: object) -> SceneProfile: ...
